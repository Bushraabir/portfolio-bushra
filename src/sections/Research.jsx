...
const books = [
  {
    ...
    description: "This work delves into the fundamental forces—gravity, electromagnetism, and nuclear forces—shaping the universe. It aims to simplify complex physics concepts, offering a clear understanding of the forces that govern everything from our planet to the cosmos."
  },
  {
...
const articles = [
  ...
  },
  {
    ...
    img: schrodinger_cat,
    description: "At the dawn of the 20th century, physicists categorized three main types of radioactive decay: 1.Alpha decay: A nucleus emits a helium nucleus (two protons and two neutrons), effectively shifting two places down the periodic table. 2.Beta decay: A nucleus emits a high-energy electron, causing an element to move one place up the periodic table. 3.Gamma decay: A nucleus transitions to a lower-energy state by emitting a photon (gamma ray), remaining the same element. In alpha and gamma decays, the laws of energy and momentum conservation always matched perfectly. In beta decay, however, physicists noticed an apparent loss of both energy and momentum — until Wolfgang Pauli hypothesized the existence of a ghostly particle that balanced the books: the neutrino. Because neutrinos interact only weakly with matter, Pauli famously worried they would be “undetectable.” Yet, by 1956, antineutrinos were experimentally confirmed near nuclear reactors."
  },
  {
  ...
  },
  {
    ...
    img: Expanding,
    description: "For millennia, humanity saw the cosmos as eternal and unchanging. Yet, in the early 20th century, a revolutionary discovery emerged: the universe is expanding. Over the years, cosmologists have pieced together evidence of this expansion, explored its origins in the Big Bang, and investigated its mysterious drivers — particularly dark energy. For millennia, humanity saw the cosmos as eternal and unchanging. Yet, in the early 20th century, a revolutionary discovery emerged: the universe is expanding. Over the years, cosmologists have pieced together evidence of this expansion, explored its origins in the Big Bang, and investigated its mysterious drivers — particularly dark energy."
  },
  {
...
const researchPapers = [
  {
    ...
    img: MCU,
    tags: ["Architecture", "Future"],
    description: "This paper explores the design, fabrication, and characterization of a low-voltage, high-density integrated circuit, focusing on performance optimization and practical applications in modern electronics."
  },
  {
    ...
    img: BlackHole,
    tags: ["Programming", "Creativity"],
    description: "This paper explores a potential solution to the black hole singularity problem, proposing that black holes are 4D objects. Everything that falls into a black hole is absorbed into this 4D space and vaporized by Hawking radiation. From our 3D perspective, the singularity appears infinite, but if black holes were 3D objects, they would appear infinite to a 2D observer. This analogy suggests that the singularity might not be infinite, but a result of our limited perspective."
  }
];
