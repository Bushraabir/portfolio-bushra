  ...
  return (
    ...
    >
      <div className="container px-6 mx-auto text-center lg:px-20">
        ...
        <div className="flex justify-center mt-10 mb-12 space-x-8">{renderTabs()}</div>
      ...
      {selectedArtwork && (
        ...
        >
          <motion.div
            className={`relative bg-[#1B1B34] ${isMobile ? "w-full h-full p-4" : "p-8 rounded-3xl shadow-2xl max-w-3xl mx-auto"}`}
          ...
          >
            ...
            <motion.img
              ...
              className={`w-full h-auto rounded-xl shadow-xl transition-all duration-500 ${isMobile ? "max-h-[50vh] object-contain" : ""}`}
              initial={{ opacity: 0, scale: 1.1 }}
              animate={{ opacity: 1, scale: 1 }}
            />
