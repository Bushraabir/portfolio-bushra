    ...
    >
      ...
      <div className="mt-6">
        <motion.h3
          ...
          initial="hidden"
          animate="visible"
          className="text-3xl font-semibold font-heading transition-all duration-500 text-aquamarine hover:text-jordy_blue"
        >
          {name}
        </motion.h3>
        <motion.p
          ...
          initial="hidden"
          animate="visible"
          className="mt-3 transition-all duration-300 font-description text-lemon_chiffon hover:text-champagne_pink"
        >
          {description}
        </motion.p>
      </div>
      <div className="flex flex-wrap gap-3 mt-6">
        {tags.map((tag, tagIndex) => (
          <motion.span
            ...
            initial="hidden"
            animate="visible"
            className={`text-sm font-semibold font-description text-lemon_chiffon ${tag.color} px-5 py-2 rounded-full shadow-xl transition-all duration-300 hover:bg-aquamarine hover:text-jordy_blue`}
          >
            #{tag.name}
          </motion.span>
        ))}
      ...
      <div className="flex flex-wrap gap-3 mt-6">
        {tags.map((tag, tagIndex) => (
          <motion.span
            ...
            initial="hidden"
            animate="visible"
            className={`text-sm font-semibold font-description text-lemon_chiffon ${tag.color} px-5 py-2 rounded-full shadow-lg transition-all duration-300 hover:bg-aquamarine hover:text-jordy_blue`}
          >
            #{tag.name}
          </motion.span>
        ))}
            ...
            >
              ...
              >
                <a
                  ...
                  className="px-6 py-3 text-lg font-medium font-cta transition-all transform rounded-full shadow-2xl text-lemon_chiffon bg-gradient-to-r from-aquamarine to-jordy_blue hover:opacity-90 hover:scale-110"
                >
                  View Source Code
                </a>
              </motion.div>
