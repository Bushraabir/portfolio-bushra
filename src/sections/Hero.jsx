...
const Hero = () => {
    ...
    return (
        <section
         className="relative z-10 flex flex-col items-center justify-center min-h-screen p-6 bg-transparent"
        ...
        >
         <div className="relative flex flex-col items-center text-center lg:flex-row lg:text-left lg:justify-between lg:w-3/4">
           <div className="flex flex-col items-center text-left lg:items-start">
             <motion.p
               className="mt-4 text-lg sm:text-xl md:text-2xl text-glow text-lemon_chiffon font-description tracking-wider leading-relaxed"
             ...
             <motion.h1
               className="text-4xl sm:text-5xl md:text-6xl font-heading text-left text-transparent bg-gradient-to-r from-champagne_pink to-pink_lavender bg-clip-text leading-tight tracking-tight"
               initial={{ opacity: 0, y: 50 }}
               whileInView={{ opacity: 1, y: 0 }}
               viewport={{ once: true }}
             ...
             <motion.p
               className="mt-4 text-lg sm:text-xl md:text-2xl text-glow text-mauve font-subheading tracking-wide leading-relaxed"
               initial={{ opacity: 0, y: 50 }}
               whileInView={{ opacity: 1, y: 0 }}
               viewport={{ once: true }}
               transition={{ duration: 2, delay: 0.5, ease: "easeOut" }}
             >
               ...
               How many intelligent lives are there?<br />
               Is there any intelligent being named <strong>Bushra Khandoker</strong>?<br /> I
               wonder...
             </motion.p>
           </div>
         ...
         <div className="flex flex-col md:flex-row gap-4 mt-6 font-cta">
           <motion.button
             ref={buttonRef}
           ...
           <motion.a
             ...
             className="relative px-6 py-3 text-lg font-semibold text-white tracking-wider transition-all transform border-4 border-lemon_chiffon rounded-2xl bg-gradient-to-r from-jordy_blue to-mauve hover:bg-transparent hover:border-jordy_blue hover:scale-110 focus:outline-none focus:ring-4 focus:ring-jordy_blue"
             whileHover={{ scale: 1.1 }}
             whileTap={{ scale: 0.95 }}
             style={{ pointerEvents: "auto" }}
           >
         ...
         <motion.div
           ...
           style={{ pointerEvents: "none" }}
         >
           <p className="-mt-20 text-sm sm:text-md text-glow text-jordy_blue tracking-wide leading-relaxed">
